function y = nmer_gaussian_shot_sigma_zeromu_f_priors5_pdf(x, nmer, g, k, varargin)
...
% fudge factor increasing the width of the non-zero
...
coeff(1, 1, 1) = 1;
covar2(1, 1, :) = ...
((sqrt(g + k .* spacing .* covar(1, 1, :)) ./ k).* coeff(1, 1, :)) .^ 2;
