function y = nmer_gaussian_one_sigma_zeromu_pdf(x, nmer, varargin)
...
%
% y = nmer_gaussian_one_sigma_zeromu_f_pdf(x, nmer, parms)
%
% y - probability densities
% x - input data
% nmer -- multimer size (i.e., nmer = 6 for a hexamer)
% parms - [xp0 sigma spacing f] 
...
y = pdf(distn,x);
global parm_names
parm_names= {'xp0'; 'sigma'; 'spacing'; 'label frac.'};
end
%% notice
