function y = three_gen_gaussian_global_mus_sigma_pdf(fit_category, fit_data, n_cdns, varargin)
...
%
% This termed a generalized ("gen") guassian model because it allows the
% individual amplitudes in the mixture model to be <0 or >1 (but they must
% still sum to 1).
%
% Inputs:
