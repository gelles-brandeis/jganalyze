function y = nmer_gaussian_shot_sigma_zeromu_f_priors2_pdf(x, nmer, g, k, varargin)
...
% except there is an additional fudge factor increasing the width of the
% peaks to compensate for population heterogeneity due to uneven
% illumination.
%
% Requires statistics toolbox
%
% y = nmer_gaussian_shot_sigma_zeromu_f_priors_pdf(x, nmer, g, k,  parms)
%
...
global parm_names
parm_names= {'xp0'; 'spacing'; 'label frac.'};
end
%% notice
