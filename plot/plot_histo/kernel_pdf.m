function [yi, l_ci, u_ci] = kernel_pdf(dwells, plot_x, nboot, ci, all_pos)
...
% all_pos - if true (default) all dwells are postitive (the usual case!)
%
% yi - histo values
%%
...
[yi, ~] = ksdensity(dwells, plot_x, 'support', support);
...
if nboot > 0
    ...
    parfor n = 1:nboot
        ...
        boot_results(n,:) = ksdensity(boot_dwells,plot_x,'support',support);
    end
